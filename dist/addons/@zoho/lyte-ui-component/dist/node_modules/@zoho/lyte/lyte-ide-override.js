        ...
        if(comp.activeInstances > 0) {
            ...
            if(Lyte.Compile.getDynamicNodes) {
                ...
                if(returnVal.errors){
                    ...
                    var docTemplate = LyteComponent.lyteComponentsDiv.querySelector("template[tag-name="+componentName+ "]")
                    if(docTemplate) {
                        var docTemplateCopy = Array.from(LyteComponent.lyteComponentsDiv.querySelectorAll("template[tag-name="+componentName+ "]"));
