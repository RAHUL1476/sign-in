     ...
     data : function (){
        ...
        __value;
          ...
          return {
             ...
             ltPropPlaceholder : __attr(__string, { default : default_values.search || '' }),
             ltPropAutofocus : __attr( __boolean, { default : default_values.autofocus || false }),
             ltPropDisabled : __attr( __boolean, { default : false }),
             ltPropStyle : __attr( __string,{ default : default_values.style || '' }),
             ltPropMaxlength : __attr( __number, { default : default_values.maxlength || 25 }),
             ltPropReadonly : __attr( __boolean, { default : false }),
             ltPropId : __attr( __string, { default : default_values.id || 'inputId' }),
             ltPropClass : __attr( __string, { default : default_values.class || '' }),
             ltPropType : __attr( __string, { default : 'search'}),
             ltPropName : __attr( __string, { default : '' }),
             ltPropWidth : __attr( __string, { default : default_values.width || '100%' }),
             ltPropHeight  : __attr( __string, { default : default_values.height || '' }),
             ltPropValue : __attr( __string, { default : ''}),
             ltPropAppearance : __attr( __string, { default : default_values.appearance || 'flat' }),
              ...
              * @default {}
              */
             ltPropQuerySelector : __attr( __object, { default : {} }),
             /**
              * @componentProperty {number} ltPropMinLength=1
              * @version 1.0.0
              */
             ltPropMinLength : __attr( __number, { default : ( __value = default_values.minLength ) == void 0 ? 1 : __value }),
             /**
              * @componentProperty {startsWith | endsWith | contains} ltPropMethod=contains
              * @version 1.0.0
              */
             ltPropMethod : __attr( __string, { default : default_values.method || 'contains' }),
              ...
              */
             ltPropAjaxRequest : __attr( __object, { default : {}}),
             ltPropAutoUpdate : __attr( __boolean, { default : true}),
             ...
             ltPropSearchDelay : __attr( __number, { default : default_values.hasOwnProperty( 'searchDelay' ) ? default_values.searchDelay : 100 } ),
             /**
              * @componentProperty {boolean} ltPropCaseSensitive=false
              * @version 2.2.10
              */
             ltPropCaseSensitive : __attr( __boolean, { default : default_values.caseSensitive || false } ),
             /**
              * @componentProperty {string} ltPropComponent
              * @version 2.0.0
              */
             ltPropComponent : __attr( __string, { default : undefined } ),
             /**
              * @componentProperty {boolean} ltPropTrim=false
              * @version 2.2.6
              */
             ltPropTrim : __attr( __boolean, { default : default_values.trim || false } ),
             ltPropFocus : __attr( __boolean, { default : default_values.focus || false } ),
             ...
             ltPropDiacritic : __attr( __boolean, { default : default_values.diacritic || false } ),
             ...
             ltPropMaintainState : __attr( __boolean, { default : ( __value = default_values.maintainState ) == void 0 ? true : __value } ),
             ...
             ltPropPreventEmptyKeys : __attr( __boolean, { default : default_values.preventEmptyKeys || false } ),
            ...
            /**
             ...
             ltPropMultipleSearch : __attr( __boolean, { default : default_values.multipleSearch || false } ),
              ...
              */
              ...
              ltPropIgnoreChildren : __attr( __boolean, { default : default_values.ignoreChildren || false } ),
              ...
              */
              ...
              ltPropInput : __attr( __string, { default : default_values.input || '{}' } ),
             ...
             //system data
             timeout : __attr( __number, { default : undefined}),
             ltPropCheckFromParent : __attr( __boolean, { default : false})
