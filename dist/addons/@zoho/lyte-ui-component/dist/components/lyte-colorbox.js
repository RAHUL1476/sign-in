	...
	launch : function(element,event) {
		...
		if (!LyteColorbox._closing) {
			...
			if (!LyteColorbox._open) {
				...
				LyteColorbox._content.setAttribute('aria-labelledby',LyteColorbox._title.getAttribute('id'))
