...
_observedAttributes :["ltPropYield","ltPropHover","ltPropActiveClass","ltPropPosition","ltPropCloseIcon","prevTarget","ltPropHeight","ltPropType","ltPropMaxWidth","ltPropTabStyle","ltPropMenuWrapperClass","ltPropCurrentTab","ltPropAriaTabActivation","menuLabels"],
    ...
    data: function () {
        return {
            ...
            'ltPropAriaTabActivation' : Lyte.attr('boolean',{"default": true}),
            ...
            **-- NOT REQUIRED NOW --** */
            ...
            for (var i = 0; i < contents.length; i++) {
                ...
                if (pos && (pos === i || labels[pos].getAttribute('lt-prop-id') === contents[i].id)) {
                    ...
                    this.executeOnOpen(labels[pos], labels[pos].getAttribute('lt-prop-id'), null, null);
                }
                else {
            ...
            if (!pos) {
                pos = 0;
                this.executeOnBeforeOpen(labels[0], labels[0].getAttribute('lt-prop-id'), null, null);
                ...
                this.setData('ltPropCurrentTab', { 'index': pos, 'name': labels[pos].textContent.trim() });
                this.executeOnOpen(labels[0], labels[0].getAttribute('lt-prop-id'), null, null);
            }
    ...
    executeOnBeforeOpen: function (clickedItem, targetId, prevEleId, event) {
        var returnVal;
    ...
    executeOnOpen: function (clickedItem, targetId, event) {
