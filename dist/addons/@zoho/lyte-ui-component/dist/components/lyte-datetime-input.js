...
_template:"<template tag-name=\"lyte-datetime-input\"> <div class=\"lyteDateTimeInputWrapper\"> <input type=\"text\" lyte-purpose=\"date\" class=\"lyteDateTimeDate\" disabled=\"{{ltPropDisabled}}\" readonly=\"{{ltPropReadonly}}\" value=\"{{lbind(dateValue)}}\" onfocus=\"{{action('focus',event,this)}}\" onblur=\"{{action('blur',event,this)}}\" oninput=\"{{action('input',event,this)}}\" onkeydown=\"{{action('keydown',event,this)}}\"> <template is=\"if\" value=\"{{ltPropDropdown}}\"><template case=\"true\"> <lyte-dropdown class=\"lyteDateInputDropdown\" lt-prop-selected=\"{{lbind(selected)}}\" lt-prop=\"{{ltPropDropdownProperties}}\" on-before-show=\"{{method('beforeShow')}}\" on-option-selected=\"{{method('timeselect')}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <lyte-drop-button> <input type=\"text\" lyte-purpose=\"time\" class=\"lyteDateTimeTime\" disabled=\"{{ltPropDisabled}}\" readonly=\"{{ltPropReadonly}}\" value=\"{{lbind(timeValue)}}\" onfocus=\"{{action('focus',event,this)}}\" onblur=\"{{action('blur',event,this)}}\" oninput=\"{{action('input',event,this)}}\" onkeydown=\"{{action('keydown',event,this)}}\"> <template is=\"if\" value=\"{{timezone}}\"><template case=\"true\"> <span class=\"lyteDateTimezone\">{{timezone}}</span> </template></template> </lyte-drop-button> <lyte-drop-box class=\"lyteDaterangeInputDropdown\"> <template is=\"if\" value=\"{{ltPropHeaderYield}}\"><template case=\"true\"> <lyte-drop-head> <lyte-yield yield-name=\"timeheader\"></lyte-yield> </lyte-drop-head> </template></template> <lyte-drop-body> <template is=\"if\" value=\"{{ltPropTimeYield}}\"><template case=\"true\"><template is=\"for\" items=\"{{dropdown}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-timezone=\"{{item.timezone}}\" data-value=\"{{item.format}}\"> <lyte-yield yield-name=\"dropYield\" item-value=\"{{item}}\"></lyte-yield> </lyte-drop-item> </template></template><template case=\"false\"> <template is=\"for\" items=\"{{dropdown}}\" item=\"item\" index=\"index\"> <lyte-drop-item data-timezone=\"{{item.timezone}}\" data-value=\"{{item.format}}\"> <span class=\"lyteDateValue\">{{item.time}}</span> <template is=\"if\" value=\"{{item.timezone}}\"><template case=\"true\"> <span class=\"lyteDateTimezoneValue\">{{item.timezone}}</span> </template></template> </lyte-drop-item> </template> </template></template> </lyte-drop-body> </lyte-drop-box> </template> </lyte-dropdown> </template><template case=\"false\"> <div> <input type=\"text\" lyte-purpose=\"time\" class=\"lyteDateTimeTime\" disabled=\"{{ltPropDisabled}}\" readonly=\"{{ltPropReadonly}}\" value=\"{{lbind(timeValue)}}\" onfocus=\"{{action('focus',event,this)}}\" onblur=\"{{action('blur',event,this)}}\" oninput=\"{{action('input',event,this)}}\" onkeydown=\"{{action('keydown',event,this)}}\"> <template is=\"if\" value=\"{{timezone}}\"><template case=\"true\"> <span class=\"lyteDateTimezone\">{{timezone}}</span> </template></template> </div> </template></template> </div> <template is=\"if\" value=\"{{ltPropBindToBody}}\"><template case=\"true\"> <lyte-wormhole class=\"lyteDateTimeInputWormhole lyteDateTimeInputHidden\" on-before-append=\"{{method('beforeAppend')}}\"> <template is=\"registerYield\" yield-name=\"lyte-content\"> <lyte-calendar lt-prop=\"{{ltPropCalendarProperties}}\" lt-prop-yield=\"{{ltPropCalendarYield}}\" lt-prop-format=\"{{ltPropDateFormat}}\" lt-prop-min-date=\"{{minDate}}\" lt-prop-max-date=\"{{maxDate}}\" lt-prop-current-date=\"{{lbind(dateValue)}}\" on-date-selected=\"{{method('dateselect')}}\" on-navigate=\"{{method('navigate','onNavigate')}}\" on-view-change=\"{{method('navigate','onViewChange')}}\"> <template is=\"registerYield\" yield-name=\"footer\" from-parent=\"\"></template> </lyte-calendar> </template> </lyte-wormhole> </template></template> </template>",
_dynamicNodes : [{"type":"attr","position":[1,1]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}},{"type":"componentDynamic","position":[1]},{"type":"attr","position":[3,1]},{"type":"if","position":[3,1],"cases":{"true":{"dynamicNodes":[{"type":"insertYield","position":[1,1]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[3,3,1]},{"type":"if","position":[3,3,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[0]},{"type":"for","position":[0],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"insertYield","position":[1,1]},{"type":"componentDynamic","position":[1]}]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"for","position":[1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}},{"type":"componentDynamic","position":[1]}]}]}},"default":{}},{"type":"componentDynamic","position":[3,3]},{"type":"componentDynamic","position":[3]}]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1,1]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[3]},{"type":"if","position":[3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1]}]}},"default":{}}],
_observedAttributes :["ltPropValue","ltPropDateFormat","ltPropTimeFormat","ltPropMaxDate","ltPropMinDate","ltPropType","ltPropDateProperties","ltPropTimeProperties","ltPropCalendarProperties","ltPropDropdownProperties","ltPropDropdown","ltPropCalendarYield","ltPropTimeYield","ltPropHeaderYield","ltPropBoundary","ltPropOffset","ltPropInterval","ltPropPosition","ltPropPreventEmpty","ltPropAllowKeys","ltPropI18n","ltPropAppearance","ltPropDisabled","ltPropReadonly","ltPropAria","ltPropDateAriaAttributes","ltPropTimeAriaAttributes","dateValue","timeValue","timezone","minDate","maxDate","dropdown","lastDate","selected","minDate","maxDate"],
	...
	data : function(){
		...
		return {
			...
			ltPropValue : attr( str, { default : "" } ),
			ltPropDateFormat : attr( str, { default : "MM/DD/YYYY" } ),
			ltPropTimeFormat : attr( str, { default : "hh:mm A" } ),

			ltPropMaxDate : attr( str, { default : "" } ),
			ltPropMinDate : attr( str, { default : "" } ),

			ltPropType : attr( str, { default : "datetime" } ),

			ltPropDateProperties : attr( obj, { default : {}, watch : true } ),
			ltPropTimeProperties : attr( obj, { default : {}, watch : true } ),

			ltPropCalendarProperties : attr( str, { default : '{}' } ),
			ltPropDropdownProperties : attr( str, { default : '{"freeze" : false}' } ),

			ltPropDropdown : attr( bool, { default : false } ),

			ltPropCalendarYield : attr( bool, { default : false } ),
			ltPropTimeYield : attr( bool, { default : false } ),
			ltPropHeaderYield : attr( bool, { default : false } ),

			ltPropBoundary : attr( obj, { default : {} } ),
			ltPropOffset : attr( obj, { default : {} } ),

			ltPropInterval : attr( 'number', { default : 30 } ),

			ltPropPosition : attr( str, { default : "bottom" } ),

			ltPropPreventEmpty : attr( bool, { default : true } ),
			ltPropAllowKeys : attr( bool, { default : true } ),

			ltPropI18n : attr( bool, { default : false } ),

			ltPropAppearance : attr( str, { default : "box" } ),

			ltPropDisabled : attr( bool, { default : false } ),

			ltPropReadonly : attr( bool, { default : false } ),

			ltPropAria : attr( bool, { default : false } ),

			ltPropDateAriaAttributes : attr( obj, { default : {}, watch : true } ),
			ltPropTimeAriaAttributes : attr( obj, { default : {}, watch : true } ),

			dateValue : attr( str, { default : "" } ),
			timeValue : attr( str, { default : "" } ),
			timezone : attr( str ),

			minDate : attr( str ),
			maxDate : attr( str ),

			dropdown : attr( 'array', { default : [] } ),
			lastDate : attr( str ),
			selected : attr( str ),
