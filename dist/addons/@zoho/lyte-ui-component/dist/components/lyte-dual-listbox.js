...
_observedAttributes :["ltPropLeftData","ltPropRightData","ltPropSortable","ltPropShortcut","ltPropAssociateParent","ltPropShowToolbar","ltPropSearchScope","ltPropToolbarItems","ltPropMaxCount","ltPropDoubleClick","ltPropSelectAllChild","ltPropNoResultMessage","ltPropAriaRoleDescription","ltPropKeepOriginal","listboxLeftAriaDescendant","listboxRightAriaDescendant","ariaLabelledById","focusActiveBoolean","ariaLiveContentBoolean","ariaLiveContent","dragHasStarted","noResultsFound","moveRight","moveLeft","moveTop","moveBottom","deleteElement","moreLBElements","selectedIndexLeft","selectedIndexRight","leftShiftSelectIndex","rightShiftSelectIndex","insertAtLeftInd","insertAtRightInd","elementPosition","activeSide","previousClickedElemDomInd","focusedOnTab","initialClientX","initialClientY","firstUpDownClick"],
  ...
  didConnect: function() {
    ...
    $L(this.$node).find('.lyteLBToolbarItems:not(.lyteLBTBMoveAllRight,.lyteLBTBMoveAllLeft)').addClass('lyteDLBDisabledToolbar')
  ...
  moveAllElementsLeft: function(th) {
    this.clearSearch()
    var lB = this.$node;
    $L(lB).find('.lyteListBoxRightElement:not(.lyteListBoxRequiredItem,.lyteLBoxDisabledParent)').addClass('lyteLBRightActive lyteLBRightMoveElement');
  ...
  updateDomIndex : function(){
    ...
    $L(lB).find('.lyteListBoxLeftElement:not(.lyteListBoxRequiredItem,.lyteLBoxDisabledParent,.lyteSearchHidden)').map(function(x){
      $L(this).attr("dom-index" , x+1)
      $L(this).attr("id" , "lyteLbLeft_"+(x+1))
    })

    $L(lB).find('.lyteListBoxRightElement:not(.lyteListBoxRequiredItem,.lyteLBoxDisabledParent,.lyteSearchHidden)').map(function(x){
      $L(this).attr("dom-index" , x+1)
