...
_template:"<template tag-name=\"lyte-nav\"> <template is=\"if\" value=\"{{expHandlers(ltPropAlignment,'!==','vertical')}}\"><template case=\"true\"> <template is=\"if\" value=\"{{ltPropNavYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"nav\" items=\"{{auxArray}}\" role=\"list\"></lyte-yield> </template><template case=\"false\"> <template is=\"for\" items=\"{{auxArray}}\" item=\"item\" index=\"index\"> <lyte-nav-item data-value=\"{{item[ltPropSystemValue]}}\" lyte-shortcut=\"{{lyteUiGetValue(item,'shortcut')}}\">{{item[ltPropUserValue]}}</lyte-nav-item> </template> </template></template> <template is=\"if\" value=\"{{expHandlers(ltPropType,'===','collapse')}}\"><template case=\"true\"> <template is=\"if\" value=\"{{expHandlers(expHandlers(menuContent.length,'>',0),'||',showMenu)}}\"><template case=\"true\"> <span class=\"{{ltPropContainerClass}}\" role=\"button\" aria-expanded=\"false\" aria-labelledby=\"{{randomId}}\" tabindex=\"0\"> <span class=\"{{ltPropMenuIcon}}\"></span> </span> <span id=\"{{randomId}}\" class=\"lyteVisuallyHidden\" aria-hidden=\"true\"> {{lyteUiI18n('lyte.nav.more.options')}} </span> </template></template> <lyte-menu lt-prop=\"{{stringify(ltPropMenu)}}\" on-menu-click=\"{{method('itemSelected')}}\" on-before-open=\"{{method('beforeOpen')}}\" on-open=\"{{method('open')}}\" on-before-close=\"{{method('beforeClose')}}\" on-close=\"{{method('close')}}\" before-render=\"{{method('befRender')}}\" after-render=\"{{method('aftRender')}}\"> <template is=\"registerYield\" yield-name=\"yield\"> <template is=\"if\" value=\"{{ltPropMenuYield}}\"><template case=\"true\"> <lyte-yield yield-name=\"menu\" items=\"{{menuContent}}\"></lyte-yield> </template><template case=\"false\"> <lyte-menu-body class=\"{{ltPropNavMenuClass}}\"> <template is=\"for\" items=\"{{menuContent}}\" item=\"item\" index=\"index\"> <lyte-menu-item data-value=\"{{item[ltPropSystemValue]}}\" lyte-shortcut=\"{{lyteUiGetValue(item,'shortcut')}}\"> <lyte-menu-label> {{item[ltPropUserValue]}} </lyte-menu-label> </lyte-menu-item> </template> </lyte-menu-body> </template></template> </template> </lyte-menu> </template></template> </template></template> </template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"insertYield","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"for","position":[1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,0]},{"type":"componentDynamic","position":[1]}]}]}},"default":{}},{"type":"attr","position":[3]},{"type":"if","position":[3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"attr","position":[3]},{"type":"text","position":[3,1]}]}},"default":{}},{"type":"attr","position":[3]},{"type":"registerYield","position":[3,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"if","position":[1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"insertYield","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"for","position":[1,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,1]},{"type":"componentDynamic","position":[1,1]},{"type":"componentDynamic","position":[1]}]},{"type":"componentDynamic","position":[1]}]}},"default":{}}]},{"type":"componentDynamic","position":[3]}]}},"default":{}}]}},"default":{}}],
