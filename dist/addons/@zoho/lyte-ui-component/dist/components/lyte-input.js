...
_observedAttributes :["ltPropDisabled","ltPropAutofocus","ltPropAutocomplete","ltPropMaxlength","ltPropName","ltPropPlaceholder","ltPropReadonly","ltPropValue","ltPropWidth","ltPropTabIndex","ltPropType","ltPropAppearance","ltPropDirection","ltPropLabel","ltPropId","ltPropClass","ltPropStyle","ltPropWrapperStyle","ltPropHeight","ltPropPattern","ltPropInputTitle","ltPropRows","ltPropCols","ltPropTextAreaResize","ltPropMax","ltPropMin","ltPropStep","ltPropTimeFormat","ltPropHourInterval","ltPropDefaultTime","ltPropMinuteInterval","ltPropDropdown","ltPropShowInterval","ltPropStartTime","ltPropEndTime","ltPropConvertToNearest","ltPropValidateOnBlur","ltPropFillRows","ltPropNumberOfRows","ltPropMinDate","ltPropMaxDate","ltPropStartWeekDay","ltPropMonthHeaderFormat","daysOfWeek","ltPropYear","ltPropFormat","viewDate","ltPropStartDate","ltPropEndDate","ltPropCurrentDate","ltPropBindToBody","ltPropCalendarClass","ltPropHeaderType","ltPropDropdownDisabled","ltPropDropdownShow","ltPropDropdownCallout","ltPropDropdownFreeze","ltPropDropdownId","ltPropDropdownClass","ltPropPosition","ltPropBoundary","ltPropWheel","ltPropYield","ltPropAnimate","ltPropPreventSelection","ltPropPreventKeys","ltPropUpdateDelay","ltPropAutoUpdate","ltPropCallbackDelay","ltPropCloseIcon","ltPropTimePlaceholder","ltPropCommonPlaceholder","ltPropTimeClass","ltPropAria","ltPropAriaAttributes","ltPropFocus","ltPropCalendarProperties","ltPropDropdownProperties","ltPropScope","ltPropHeaderYield","ltPropConvertedDate","ltPropConvertedTime","ltPropPreventDropdownNavigation","ltPropInputWrapperClass","ltPropWrapperClass","ltPropTimezoneHandling","eventListeners","selectedField","endMinute","startMinute","dropdownData","originalData","dateRange","meridian","hour","min","selectedDateField","preventObs","resize","resizeClass","pos","isSearch","isBox","dateOrder","showPlaceholder","lyteUnbound","randomId","navigation"],
    ...
    rsizefun : function( evt ){
     ...
     mouseup : function( evt ){
        ...
        __this.getMethods( cb ) && __this.executeMethod( cb, evt, __this._resize_move, __this.$node );
    ...
    data : function(){
        ...
        return {
            ...
            * @version 1.0.0
            */            
            ltPropDisabled : __attr( __boolean, { default : false }),
           /**
            * @componentProperty {boolean} ltPropAutofocus=false
            * @version 1.0.0
            */            
            ltPropAutofocus : __attr( __boolean, { default : false }),
           /**
            * @componentProperty {on | off} ltPropAutocomplete=off
            * @version 1.0.0
            */            
            ltPropAutocomplete : __attr( __string, { default : default_values.autocomplete || 'off' }),
           /**
            * @componentProperty {number} ltPropMaxlength
            * @version 1.0.0
            */            
            ltPropMaxlength : __attr( __number, { default : default_values.maxlength }),
           /**
            * @componentProperty {string} ltPropName=''
            * @version 1.0.0
            */            
            ltPropName : __attr( __string, { default : '' }),
           /**
            * @componentProperty {string} ltPropPlaceholder=''
            * @version 1.0.0
            */            
            ltPropPlaceholder : __attr( __string, { default : '' }),
           /**
            * @componentProperty {boolean} ltPropReadonly=false
            * @version 1.0.0
            */            
            ltPropReadonly : __attr( __boolean, { default : false }),
           /**
            * @componentProperty {string} ltPropValue=''
            * @version 1.0.0
            */            
            ltPropValue : __attr( __string, { default : '' }),
           /**
            * @componentProperty {string} ltPropWidth=''
            * @version 1.0.0
            */            
            ltPropWidth : __attr( __string, { default : default_values.width || '' }),
           /**
            * @componentProperty {string} ltPropTabIndex=0
            * @version 1.0.0
            */            
            ltPropTabIndex : __attr( __string, { default : default_values.tabIndex || '0' }),
           /**
            * @componentProperty {text | number | password | date | time | textarea | datetime} ltPropType=text
            * @version 1.0.0
            */            
            ltPropType : __attr( __string, { default : '' }),
           /**
            * @componentProperty {flat | box} ltPropAppearance=box
            * @version 1.0.0
            */            
            ltPropAppearance : __attr( __string, { default : default_values.appearance || '' }),
           /**
            * @componentProperty {vertical | horizontal} ltPropDirection=vertical
            * @version 1.0.0
            */            
            ltPropDirection : __attr( __string, { default : default_values.direction || 'vertical' }),
           /**
            * @componentProperty {string} ltPropLabel=''
            * @version 1.0.0
            */            
            ltPropLabel : __attr( __string, { default : '' }),
           /**
            * @componentProperty {string} ltPropId=''
            * @version 1.0.0
            */            
            ltPropId : __attr( __string, { default : '' }),
           /**
            * @componentProperty {string} ltPropClass=''
            * @version 1.0.0
            */            
            ltPropClass : __attr( __string, { default : default_values.class || '' }),
           /**
            * @componentProperty {string} ltPropStyle=''
            * @version 1.0.0
            */            
            ltPropStyle : __attr( __string, { default : default_values.style || '' }),
           /**
            * @componentProperty {string} ltPropWrapperStyle=''
            * @version 1.0.0
            */            
            ltPropWrapperStyle : __attr( __string, { default : default_values.wrapperStyle || '' }),
           /**
            * @componentProperty {string} ltPropHeight=''
            * @version 1.0.0
            */            
            ltPropHeight : __attr( __string, { default : default_values.height || '' }),
           /**
            * @componentProperty {string} ltPropPattern='.+'
            * @version 1.0.2
            */            
            ltPropPattern : __attr( __string, { default : default_values.pattern || '.+' }),
           /**
            * @componentProperty {string} ltPropInputTitle=''
            * @version 1.0.2
            */            
            ltPropInputTitle : __attr( __string, { default : '' }),
            ...
            */            
            ltPropRows : __attr( __number, { default : void 0 }),
           /**
            * @componentProperty {number} ltPropCols
            * @version 1.0.0
            * @condition ltPropType textarea
            */            
            ltPropCols : __attr( __number, { default : void 0 }),
            /**
             ...
             * @condition ltPropType textarea
             */            
            ltPropTextAreaResize : __attr( __object, { default : default_values.textAreaResize || { vertical : true, horizontal : true } }),
            ...
            */            
            ltPropMax : __attr( __number, { default : void 0 }),  
           /**
            * @componentProperty {number} ltPropMin
            * @version 1.0.0
            * @condition ltPropType number
            */                      
            ltPropMin : __attr( __number, { default : void 0 }),
           /**
            * @componentProperty {number} ltPropStep=1
            * @version 1.0.0
            * @condition ltPropType number
            */                        
            ltPropStep : __attr( __number ,{ default : default_values.step || 1 }),
            ...
            * @condition ltPropType number
            */            
            ltPropTimeFormat : __attr( __number, { default : default_values.timeFormat || 12 }),
           /**
            * @componentProperty {number} ltPropHourInterval=1
            * @version 1.0.0
            * @condition ltPropType time,datetime
            */            
            ltPropHourInterval : __attr( __number, { default : default_values.hourInterval || 1 }),
           /**
            * @componentProperty {string} ltPropDefaultTime=''
            * @version 1.0.0
            * @condition ltPropType time,datetime
            */            
            ltPropDefaultTime : __attr( __string, { default : '' }),
           /**
            * @componentProperty {number} ltPropMinuteInterval=30
            * @version 1.0.0
            * @condition ltPropType time,datetime
            */            
            ltPropMinuteInterval : __attr( __number, { default : default_values.minuteInterval || 30 }),
           /**
            * @componentProperty {boolean} ltPropDropdown=false
            * @version 1.0.0
            * @condition ltPropType time,datetime
            */            
            ltPropDropdown : __attr( __boolean, { default : default_values.dropdown || false }),
           /**
            * @componentProperty {boolean} ltPropShowInterval=false
            * @version 1.0.0
            * @condition ltPropType time,datetime
            */            
             ltPropShowInterval : __attr( __boolean, { default : default_values.showInterval || false }),
           /**
            * @componentProperty {string} ltPropStartTime=''
            * @version 1.0.0
            * @condition ltPropType time,datetime
            */
            ltPropStartTime : __attr( __string, { default : default_values.startTime || '' }),
           /**
            * @componentProperty {string} ltPropEndTime=''
            * @version 1.0.0
            * @condition ltPropType time,datetime
            */
            ltPropEndTime : __attr( __string, { default : default_values.endTime || '' }),
             /**
            * @componentProperty {boolean} ltPropConvertToNearest=false
            * @version 2.2.14
            * @condition ltPropType time,datetime
            */
            ltPropConvertToNearest : __attr( __boolean, { default : default_values.convertToNearest || false }),
             /**
            * @componentProperty {boolean} ltPropValidateOnBlur=false
            * @version 2.2.14
            * @condition ltPropType time,datetime
            */
            ltPropValidateOnBlur : __attr( __boolean, { default : default_values.validateOnBlur || false }),

            // data for calendar
            ltPropFillRows : __attr( __boolean, { default : ( __value = default_values.fillRows ) == void 0 ? true : default_values }),
            ltPropNumberOfRows : __attr( __number, { default : default_values.numberOfRows || 6 }),
            ltPropMinDate : __attr( __string, { default : "" }),
            ltPropMaxDate : __attr( __string, { default : "" }),
            ltPropStartWeekDay : __attr( __number, { default : default_values.startWeekDay || 1 } ),
            ltPropMonthHeaderFormat : __attr( __string, { default: default_values.monthHeaderFormat || 'MMMM YYYY' } ),
            daysOfWeek : __attr( __array, { default : ['Sun','Mon','Tue','Wed','Thu','Fri','Sat' ] } ),
            ltPropYear : __attr( __boolean, { default : ( __value = default_values.year ) == void 0 ? true : __value } ),
            ltPropFormat : __attr( __string, { default : default_values.format || "MM/DD/YYYY" }),
            viewDate : __attr( __object, { default : {} }),
            ltPropStartDate : __attr( __string, { default : '' }),
            ltPropEndDate : __attr( __string, { default : ''}),
            ltPropCurrentDate : __attr( __string, { default : ''}),
            /**
            * @componentProperty {boolean} ltPropBindToBody=true
            * @version 2.1.0
            * @condition ltPropType time,date,datetime
            */
            ltPropBindToBody : __attr( __boolean, { default : ( __value = default_values.bindToBody ) == void 0 ? true : __value }),
           /**
            * @componentProperty {string} ltPropCalendarClass=''
            * @version 2.1.0
            * @condition ltPropType date,datetime
            */
            ltPropCalendarClass : __attr( __string, { default : default_values.calendarClass || "" }),
            ltPropHeaderType : __attr( __string, { default : default_values.headerType || "default" }),
            ...
            * @condition ltPropType time,datetime
            */
            ltPropDropdownDisabled : __attr( __boolean, { default : false}),
           /**
            * @componentProperty {boolean} ltPropDropdownShow=false
            * @version 1.0.2
            * @condition ltPropType time,datetime
            */
            ltPropDropdownShow : __attr( __boolean, { default : false}),
           /**
            * @componentProperty {boolean} ltPropDropdownCallout=false
            * @version 2.0.0
            * @condition ltPropType time,datetime
            */
            ltPropDropdownCallout : __attr( __boolean, { default : false }),
           /**
            * @componentProperty {boolean} ltPropDropdownFreeze=false
            * @version 1.0.2
            * @condition ltPropType time,datetime
            */
            ltPropDropdownFreeze : __attr( __boolean, { default : ( __value = default_values.dropdownFreeze ) == void 0 ? false : __value }),
           /**
            * @componentProperty {string} ltPropDropdownId=''
            * @version 2.2.2
            * @condition ltPropType time,datetime
            */
            ltPropDropdownId : __attr( __string, { default : '' }),
           /**
            * @componentProperty {string} ltPropDropdownClass=''
            * @version 2.2.2
            * @condition ltPropType time,datetime
            */
            ltPropDropdownClass : __attr( __string, { default : default_values.dropdownClass || '' }),

            // for dropdown and calendar
            ltPropPosition : __attr( __string, { default : default_values.position || 'down'}),
            ltPropBoundary : __attr( __object, { default : default_values.boundary || {} }),
            ...
            */
            ltPropWheel : __attr( __boolean, { default : default_values.wheel || false } ),
           /**
            * @componentProperty {boolean} ltPropYield=false
            * @version 1.0.2
            * @condition ltPropType time,datetime,date
            */
            ltPropYield : __attr( __boolean, { default : default_values.yield || false}),
            ltPropAnimate : __attr( __boolean, { default : default_values.animate || false }),
           /**
            * @componentProperty {boolean} ltPropPreventSelection=false
            * @version 2.2.9
            * @condition ltPropType date
            */
            ltPropPreventSelection : __attr( __boolean, { default : default_values.preventSelection || false }),
           /**
            * @componentProperty {boolean} ltPropPreventKeys=false
            * @version 2.2.11
            * @condition ltPropType date
            */
            ltPropPreventKeys : __attr( __boolean, { default : default_values.preventKeys || false }),
           /**
            * @componentProperty {number} ltPropUpdateDelay=250
            * @version 2.0.0
            */
            ltPropUpdateDelay : __attr( __number, { default : default_values.hasOwnProperty( 'updateDelay' ) ? default_values.updateDelay : 250 }),
           /**
            * @componentProperty {boolean} ltPropAutoUpdate=true
            * @version 1.0.2
            * @default true
            */
            ltPropAutoUpdate : __attr( __boolean, { default : ( __value = default_values.autoUpdate ) == void 0 ? true : __value }),
           /**
            * @componentProperty {number} ltPropCallbackDelay=0
            * @version 2.2.8
            */
            ltPropCallbackDelay : __attr( __number, { default : default_values.hasOwnProperty( 'callbackDelay' ) ? default_values.callbackDelay : 0 }),
           /**
            * @componentProperty {boolean} ltPropCloseIcon=false
            * @version 2.0.0
            * @condition ltPropType date,text,password,number
            */
            ltPropCloseIcon : __attr( __boolean, { default : default_values.closeIcon || false }),

            // datetime type
            /**
             * @experimental ltPropTimePlaceholder
             */
            ltPropTimePlaceholder : __attr( 'string', { default : "" }),

            ltPropCommonPlaceholder : __attr( 'string', { default : '' }),
            /**
             * @experimental ltPropTimeClass
             */
            ltPropTimeClass : __attr( __string, { default : default_values.timeClass || "" }),
            ...
            * @version 3.1.0
            */
            ltPropAria : __attr( __boolean, { default : default_values.aria || false }),
           /**
            * @componentProperty {object} ltPropAriaAttributes
            * @version 3.1.0
            * @default {}
            */
            ltPropAriaAttributes : __attr( __object, { default : default_values.ariaAttributes || {}, watch : true }),
           /**
            * @componentProperty {boolean} ltPropFocus=false
            * @version 3.2.0
            */
            ltPropFocus : __attr( __boolean, { default : false }),
           /**
            ...
            */
            ...
            ltPropCalendarProperties : __attr( __object, { default : default_values.calendarProperties || { disableNavigation : true } }),
           /**
            ...
            */
            ...
            ltPropDropdownProperties : __attr( __object, { default : default_values.dropdownProperties || {} }),
            ...
            */
            ...
            ltPropScope : __attr( __string, { default : default_values.scope || "" }),
            ...
            */
            ...
            ltPropHeaderYield : __attr( __boolean, { default : default_values.headerYield || false }),
            ...
            */
            ...
            ltPropConvertedDate : __attr( __string, { default : '' }),
            ...
            */
            ...
            ltPropConvertedTime : __attr( __string, { default : '' }),
            ...
            */
            ...
            ltPropPreventDropdownNavigation : __attr( __string, { default : default_values.preventDropdownNavigation || false }),

            /**
            * @componentProperty {string} ltPropInputWrapperClass=""
            * @version 3.30.0
            */
            ltPropInputWrapperClass : __attr( __string, { default : default_values.inputWrapperClass || '' }),

            /**
            * @componentProperty {string} ltPropWrapperClass=""
            * @version 3.32.0
            */
            ltPropWrapperClass : __attr( __string, { default : default_values.wrapperClass || "" }),

            ltPropTimezoneHandling : __attr( __boolean, { default : default_values.timezoneHandling || false }),

            // system data

            eventListeners : __attr( __object, {default : {}}),
            selectedField : __attr( __object, { default : {}}),
            endMinute : __attr( __number, { default : ''}),
            startMinute : __attr( __number, { default : ''}),
            dropdownData : __attr( __array, { default : []}),
            originalData : __attr( __array, { default : []}),
            dateRange : __attr( __object, { default : { day : [], month : [], year : []}}),
            // Dont change this property name. Already some people from crm using this for passing their custom translations
            meridian : __attr( __object, { default : {AM : (window._lyteUiUtils ? _lyteUiUtils.i18n('AM') : 'AM'), PM : (window._lyteUiUtils ? _lyteUiUtils.i18n('PM') : 'PM')}}),
            hour : __attr( __string, { default : _lyteUiUtils.i18n('hour')}),
            min : __attr( __string, { default : _lyteUiUtils.i18n('min')}),
            selectedDateField : __attr( __string, { default : ""}),
            preventObs : __attr( __boolean, { default : true}),
            resize : __attr( __boolean, { default : true}),
            resizeClass : __attr( __string, { default : "lyteTextareaResize" } ),
            pos : __attr( __string, { default : ""}),
            isSearch : __attr( __boolean, { default : false }),
            isBox : __attr( __string, { default : '' }),
            dateOrder : __attr( __array, { default : [] }),
            showPlaceholder : __attr( __boolean, { default : false }),

            lyteUnbound : __attr( __boolean, { default : false }),

            randomId : __attr( __string, { default : "" } ),

            navigation : __attr( __boolean, { default : false } )
        }
},
  ...
  timeIncrease : function(input, evt, selection, start, end, flag){
   ...
   _hideCalendar : function( bool ){
        ...
        if( this.getMethods( cb ) ) {
                ...
                * @version 2.2.8
                */            
            callback = this.executeMethod( cb, cal, this.$node );
        }
        if( callback == false ){
            this.$node.focus();
            return
