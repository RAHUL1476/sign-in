...
/**
 * @customElement lyte-alert-header
 */
/**
 * @customElement lyte-alert-content
 */
/**
 * @customElement  lyte-alert-footer
 */
...
_observedAttributes :["ltPropType","ltPropShow","ltPropWrapperClass","ltPropAllowMultiple","ltPropHeading","ltPropPrimaryMessage","ltPropSecondaryMessage","ltPropTop","ltPropButtons","ltPropButtonPosition","ltPropShowCloseButton","ltPropCloseOnEscape","ltPropDimmer","ltPropYield","ltPropAnimation","ltPropContentAlign","ltPropAria","ltPropAriaAttributes","ltPropPreventFocus","nonYieldFooter","triggerShow"],
    ...
    data: function(){
        return {
            ...
            /**
             * This property helps you to open another modal/alert/popover without closing current alert.
            ...
            /**
             * Set this property to true to show close button on the alert.
            ...
            /**
             * Sets the animation for the alert which will be shown while it opens.
            ...
            /**
             * This is a boolean property that indicates if aria attributes are provided using lt-prop-aria-attributes property or not. Setting it to true indicates that some aria attriputes are provided and those properties will be added to the alert element.
            ...
            /**
             * If set to true, it will prevent intial focus on elements inside the alert that is set by the alert. It is useful in those scenarios where any element rendered inside the alert have ltPropAutoFocus as true.
