...
_template:"<template tag-name=\"lyte-counter\"> <div class=\"counterDiv {{ltPropClass}}\" tabindex=\"{{ltPropTabIndex}}\"> <span class=\"counterNegative\">{{negative}}</span> <span class=\"counterPrefix\">{{ltPropPrefix}}</span> <span class=\"counterValue\">{{result}}</span> <span class=\"counterSuffix\">{{ltPropSuffix}}</span> </div> </template>",
...
_observedAttributes :["ltPropStart","ltPropEnd","ltPropPrefix","ltPropSuffix","ltPropDecimals","ltPropDuration","ltPropUseEasing","ltPropUseGrouping","ltPropSeparator","ltPropDecimalSeparator","ltPropState","ltPropClass","ltPropAria","ltPropAriaAttributes","ltPropTabIndex","negative","startValue","endValue","result"],
