...
_observedAttributes :["ltPropId","ltPropClass","ltPropKeepAlive","ltPropTooltipConfig","ltPropIgnoreClass","ltPropAria","tooltips"],
  ...
  didDestroy : function(){
        ...
        [ '_toolscroll', '_mousedown', '_keydown', '_mousemove', '_focusev' ].forEach( function( item ){
           delete this[ item ];
        }.bind( this ) );
  ...
  mousemove : function(event){
        ...
        while(nodeName1 && nodeName1.tagName != 'BODY' && nodeName1 != document && nodeName1.tagName != 'HTML' ){
            ...
            if( title ){
                  ...
                  nodeName1.tooltip.config = $L.extend( { position : '', appearance : 'callout', margin : 0, showdelay : 0, hidedelay : 0, maxdisplaytime : 5000, keeptooltip : false, aria : false, hideOnClick : true, startClass : "", endClass : "", animationClass : "", maxAnimationLimit : 2000 }, this.data.ltPropTooltipConfig || {} );
                  ...
                  if( this.prevTooltipNode != nodeName1 && !tooltip.tooltipSpan ){
                      ...
                      ltPropId = tooltip.config.id || this.getData( 'ltPropId' ), 
