            ...
            value: function afterConnected() {
                ...
                if (this._initProperties) {
                    ...
                    for (var _key4 in initProperties) {
                        var actVal = void 0;
                        if (compInstance.__data[_key4] && compInstance.__data[_key4].type !== _LC.getDataType(initProperties[_key4]) && (initProperties[_key4] !== undefined || compInstance.__data[_key4].type === "boolean")) {
        ...
        "affectChanges": function affectChanges(item, contextAlreadySwitched, oldValue, setterScope, newValue) {
            ...
            if (Array.isArray(item)) {
                ...
                for (var _key21 in item) {
                    this.affectChanges(item[_key21], true, oldValue ? oldValue[_key21] : oldValue, setterScope, newValue ? newValue[_key21] : newValue);
                }
            }
        },
