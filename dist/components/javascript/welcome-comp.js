...
_template:"<template tag-name=\"welcome-comp\"> <div style=\"background-color: aqua;\"> <div class=\"welc\"><h1>Login Page</h1> <form name=\"forms1\"> <label>Enter mail-Id : </label> <input id=\"text1\" type=\"text\" placeholder=\"text\" style=\"margin-left: 1%;\"><br><br> <label>Enter password : </label> <input id=\"text2\" type=\"text\" placeholder=\"text\"><br><br> <lyte-button onclick=\"{{action('gty',2)}}\" style=\"margin-left: 3%;\"> <template is=\"registerYield\" yield-name=\"text\"> Sign in </template> </lyte-button> <lyte-button onclick=\"{{action('gty',1)}}\" style=\"margin-left: 3%;\"> <template is=\"registerYield\" yield-name=\"text\"> Sign Up </template> </lyte-button> </form></div></div> </template>\n<style>.welc{\n    padding-left: 40%;\n    padding-top: 20%;\n    padding-bottom: 30%;\n}\nh1{\n    padding-left: 4%;\n}</style>",
_dynamicNodes : [{"type":"attr","position":[1,1,2,13]},{"type":"registerYield","position":[1,1,2,13,1],"dynamicNodes":[]},{"type":"componentDynamic","position":[1,1,2,13]},{"type":"attr","position":[1,1,2,15]},{"type":"registerYield","position":[1,1,2,15,1],"dynamicNodes":[]},{"type":"componentDynamic","position":[1,1,2,15]}],
