Lyte.Mixin.register("lyte-connect-positioning", {
   ...
   sort_object : function( obj, modify_key ){
      var new_obj = {},
	...
	arrangeShapes : function( obj_format, dimension, frm_didConnect ){
   ...
   double_overlap : function( nonConnected, posDetails, to_move ){
      var $node = this.$node,
      origin = {
   ...
   process_double_overlap : function( ranges, posDetails, to_move, origin, item ){
   ...
   modify_for_shake : function( shapeDetails ){
      this.find_max_min( shapeDetails );

      this.remove_wrong_parent( shapeDetails );
   },

   remove_wrong_parent : function( shapeDetails ){
   ...
   find_max_min : function( shapeDetails ){
   ...
   check_shake_pos : function( pos, ranges, dim ){
   ...
   dep_check : function( dependencies, done, vert_gape, item, ranges ){
   ...
   randomArrange : function( separateShapes, posDetails, to_move, frm_didConnect ){
   ...
   process_random_double_overlap : function( ranges, posDetails, to_move, origin, item ){
      var dim = posDetails[ item ].dimension,
      _width = dim.width,
      _height = dim.height,
