  ...
  */
  ...
  var customElementPrototype = function (_elementPrototype) {
    ...
    function customElementPrototype() {
      ...
      if (_this4.hasAttribute("lyte-rendered") || !_LyteComponent.registeredComponents[_this4.localName] || _this4._ccCalled) {
        _this4.__lyteIgnore = true;
        return _possibleConstructorReturn(_this4);
      }
      _this4.constructor.activeInstances++;
      _this4.constructor.compInstances.push(_this4);
      ...
      if (!fastRenderedProp) {
        ...
        var data = _this4.constructor._data ? _this4.constructor._data.apply(compInstance) : {};
        var def = "default";
        ...
        if (_this4.constructor._serviceToBeUsed) {
          for (var serKey in _this4.constructor._serviceToBeUsed) {
            var serName = _this4.constructor._serviceToBeUsed[serKey];
              ...
              for (var _i56 = 0; _i56 < objbind.length; _i56++) {
                ...
                for (var _key28 in item) {
                  ...
                  if (!isNaN(parsedKey) && _cond) {
                    ...
                    this.affectChanges(item[_key28], undefined, _oldObject, undefined, array[parsedKey]);
            ...
            if (array._bindings) {
              ...
              for (var _i58 = 0; _i58 < _objbind3.length; _i58++) {
                ...
                for (var _key29 in _item5) {
                  ...
                  var cond = _options.secondIndex == _options.thirdIndex ? _key29 >= _options.firstIndex && _key29 < _options.firstIndex + _options.secondIndex : _parsedKey >= _options.firstIndex;
                  if (!isNaN(_parsedKey) && cond) {
                    ...
                    this.affectChanges(_item5[_key29], undefined, _oldObject2, undefined, array[_parsedKey]);
                  }
                }
              }
            }
              ...
              for (var _i60 = 0; _i60 < _objbind4.length; _i60++) {
                ...
                for (var _key30 in _item7) {
                  ...
                  if (!isNaN(_parsedKey2) && _parsedKey2 >= _options2.firstIndex) {
                    ...
                    this.affectChanges(_item7[_key30], undefined, _oldObject3, undefined, array[_parsedKey2]);
                  }
                }
              }
            }
              ...
              for (var _i63 = 0; _i63 < arrbind.length; _i63++) {
                ...
                for (var _key31 in _item9) {
                  ...
                  if (!isNaN(_parsedKey3) && _parsedKey3 >= _options3.firstIndex) {
                    ...
                    this.affectChanges(_item9[_key31], undefined, array[_parsedKey3 + _options3.secondIndex], undefined, array[_parsedKey3]);
                  }
                }
              }
            }
    ...
    "get": function get(context, path, ac, cache) {
      ...
      if (cache && cache.hasOwnProperty(path)) {
        ...
        try {
          ...
          for (var _i79 = 1; _i79 < _arr2.length; _i79++) {
            var locVal = _arr2[_i79];
