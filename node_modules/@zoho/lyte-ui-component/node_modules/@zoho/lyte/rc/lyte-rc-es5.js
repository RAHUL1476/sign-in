    ...
    var customElementPrototype = function (_elementPrototype) {
        ...
        _createClass(customElementPrototype, [{
            ...
            value: function disconnectedCallback() {
                ...
                for (var _key16 in this._properties) {
                    this._properties[_key16] = {};
                }
                            ...
                            for (var _i57 = 0; _i57 < objbind.length; _i57++) {
                                ...
                                for (var key in item) {
                                    ...
                                    if (!isNaN(parsedKey) && _cond) {
                                        ...
                                        this.affectChanges(item[key], undefined, _oldObject, undefined, array[parsedKey]);
                ...
                case "splice":
                    {
                        ...
                        if (array._bindings) {
                            ...
                            for (var _i59 = 0; _i59 < _objbind3.length; _i59++) {
                                ...
                                for (var _key18 in _item5) {
                                    var _parsedKey = parseInt(_key18);
                                    var cond = _options.secondIndex == _options.thirdIndex ? _key18 >= _options.firstIndex && _key18 < _options.firstIndex + _options.secondIndex : _parsedKey >= _options.firstIndex;
                                    if (!isNaN(_parsedKey) && cond) {
                                        ...
                                        this.removeSelectedBindingDeep(_item5[_key18], _oldObject2);
                                        if (_item5[_key18]._forHelpers) {
                                            var _bindfor = _item5[_key18]._forHelpers.toArrayLyte();
                                        ...
                                        if (array[_parsedKey] && _typeof(array[_parsedKey]) === "object") {
                                            ...
                                            this.establishBindings({ "dummy": _item5[_key18] }, { "dummy": array[_parsedKey] });
                                        }
                                        this.affectChanges(_item5[_key18], undefined, _oldObject2, undefined, array[_parsedKey]);
                                    }
                                }
                            }
                        }
                ...
                case "remove":
                    {
                        ...
                        if (array._bindings) {
                            ...
                            for (var _i61 = 0; _i61 < _objbind4.length; _i61++) {
                                ...
                                for (var _key19 in _item7) {
                                    var _parsedKey2 = parseInt(_key19);
                                    if (!isNaN(_parsedKey2) && _parsedKey2 >= _options2.firstIndex) {
                                        ...
                                        this.removeSelectedBindingDeep(_item7[_key19], _oldObject3);
                                        if (_item7[_key19]._forHelpers) {
                                            var _bindfor2 = _item7[_key19]._forHelpers.toArrayLyte();
                                        ...
                                        if (array[_parsedKey2] && _typeof(array[_parsedKey2]) === "object") {
                                            ...
                                            this.establishBindings({ "dummy": _item7[_key19] }, { "dummy": array[_parsedKey2] });
                                        }
                                        this.affectChanges(_item7[_key19], undefined, _oldObject3, undefined, array[_parsedKey2]);
                                    }
                                }
                            }
                        }
                ...
                case "insertAt":
                    {
                        ...
                        if (array._bindings) {
                            ...
                            for (var _i64 = 0; _i64 < arrbind.length; _i64++) {
                                ...
                                for (var _key20 in _item9) {
                                    var _parsedKey3 = parseInt(_key20);
                                    if (!isNaN(_parsedKey3) && _parsedKey3 >= _options3.firstIndex) {
                                        this.removeSelectedBindingDeep(_item9[_key20], array[_parsedKey3 + _options3.secondIndex]);
                                        if (_item9[_key20]._forHelpers) {
                                            var _bindfor3 = _item9[_key20]._forHelpers.toArrayLyte();
                                        ...
                                        if (array[_parsedKey3] && _typeof(array[_parsedKey3]) === "object") {
                                            ...
                                            this.establishBindings({ "dummy": _item9[_key20] }, { "dummy": array[_parsedKey3] });
                                        }
                                        this.affectChanges(_item9[_key20], undefined, array[_parsedKey3 + _options3.secondIndex], undefined, array[_parsedKey3]);
                                    }
                                }
                            }
                        }
        ...
        "affectChanges": function affectChanges(item, contextAlreadySwitched, oldValue, setterScope, newValue) {
            ...
            if (Array.isArray(item)) {
                for (var i = 0; i < item.length; i++) {
                    for (var _key21 in item[i]) {
                        this.affectChanges(item[i][_key21], true, oldValue ? oldValue[i] ? oldValue[i][_key21] : oldValue[i] : oldValue, setterScope, newValue ? newValue[i] ? newValue[i][_key21] : newValue[i] : newValue);
                    }
                }
            } else {
                for (var _key22 in item) {
                    var oldV = oldValue ? oldValue[_key22] : oldValue,
                        newV = newValue ? newValue[_key22] : newValue;
                    if (_key22 == "*" && item[_key22].hasOwnProperty("_observers")) {
                        oldV = oldValue;
                        newV = newValue;
                    }
                    this.affectChanges(item[_key22], true, oldV, setterScope, newV);
                }
            }
        },
                ...
                case "switch":
                    {
                        ...
                        if (_Lyte._ms) {
                            ...
                            for (var _key23 in info.cases) {
                                var _contentNewCompile2 = void 0;
                                if (actualTemplateNewCompile) {
                                    _contentNewCompile2 = _LC.getContentForIE(actualTemplateNewCompile.querySelector("[case='" + LyteComponent.cssEscape(_key23) + "']"));
                                }
                                content = _LC.getContentForIE(dynNContent.querySelector("[case='" + _LC.cssEscape(_key23) + "']"), undefined, true);

                                if (content.tagName == "TEMPLATE") {
                                    info.cases[_key23]._ht = content.innerHTML;
                                }
                                if (info.cases[_key23]._ht) {
                                    content.innerHTML = info.cases[_key23]._ht;
                                    if (_contentNewCompile2) {
                                        _contentNewCompile2.innerHTML = info.cases[_key23]._ht;
                                        constr.splitTextNodes(_contentNewCompile2);
                                    }
                                    constr.splitTextNodes(content);
                                }
                                doCompile(content.tagName === "TEMPLATE" ? content.content : content, info.cases[_key23].dynamicNodes, componentName, constr, _contentNewCompile2);
                                if (actualTemplateNewCompile) {
                                    info.cases[_key23]._sta = _LC.processStatic(_contentNewCompile2);
                                }
                                if (info.cases[_key23]._ht) {
                                    info.cases[_key23]._ht = content.cloneNode(true);
                                    constr._helperTemplate.content.append(info.cases[_key23]._ht);
                                    content.innerHTML = "";
                                }
                            }
                            if (info[def].dynamicNodes) {
